    ...
    <div class="caixa-de-login">
      ...
      <form action="{{ $URL_APP }}/cadastro" method="post">
        <div class="form-check mb-2 align-left">
          ...
          <label class="form-check-label" for="cnpjCheckbox"> CNPJ </label>
        </div>
        ...
        <div class="cpf_form">
          ...
          <div class="form-floating mb-3">
            ...
            <label for="password">
              <img 
                src="{{ $URL_IMG }}/geral/cadeadosenha.svg" style="width: 20px; height: auto; padding-right: 5px;" 
                alt="AgendaPonto Logo" class="w"
              >
          ...
          <div class="form-floating mb-3">
            ...
            <label for="password">
              <img src="{{ $URL_IMG }}/geral/cadeadosenha.svg"
                style="width: 20px; height: auto; padding-right: 5px;" 
                alt="AgendaPonto Logo" class="w"
              >
